...
function createData(name, total_match,total_win,percent_win,point,rank,avatar) {
  return { name, total_match,total_win,percent_win,point,rank,avatar };
}
...
export default function EnhancedTable(props) {
  ...
  const data = props.rankingInfo.map((rank)=>{
      return createData(rank.name,rank.total_match,rank.total_win,rank.percent_win,rank.point,rank.rank,rank.avatar)
  });
              ...
              {stableSort(rows, getComparator(order, orderBy))
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      <TableCell padding="checkbox">
                      {row.avatar?<Avatar alt="Remy Sharp" src={row.avatar} className={classes.large}/>:<AccountCircle fontSize="large"/>}
                      </TableCell>
